...
docker compose exec -T backend python -m app.scripts.seed_mock_corpus || true
echo "[6/6] ready:"
echo "  Frontend : http://localhost:5173"
echo "  Swagger  : http://localhost:8000/docs"
echo "  Health   : http://localhost:8000/health"
echo "Proof: docker compose exec -T backend python -m app.scripts.test_access_control"
